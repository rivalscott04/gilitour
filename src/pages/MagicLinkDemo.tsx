        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Open the picker to search by booking ID, guest, tour, location, or status. With an empty search, the full
              list (up to 100 recent bookings) is shown. Choosing a row closes the picker.
            </p>
            {listError ? (
